...
//plugins-> masterstudy (non pro) -> _core/assets/js/buy_button.js
"use strict";
...
// 	  Our Gift Course Button - not working
	$('.stm_lms_mixed_button.gifting_course').on('click', function (e) {
		console.log(e);
       console.log("clicking gift a course");
		 $('#form-wrapper').show();
      $('.stm_lms_mixed_button').toggleClass('active');
    });
